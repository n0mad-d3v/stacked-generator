...
class DependencyConfigFactory {
  static DependencyConfig fromResolver({
    ...
    if (dependencyReader.instanceOf(const TypeChecker.typeNamedLiterally('Factory', inPackage: 'stacked_shared'))) {
      return FactoryDependency(
        ...
        .instanceOf(const TypeChecker.typeNamedLiterally('Singleton', inPackage: 'stacked_shared'))) {
      ...
      return SingletonDependency(
        ...
        .instanceOf(const TypeChecker.typeNamedLiterally('LazySingleton', inPackage: 'stacked_shared'))) {
      final ConstantReader? resolveUsing =
          dependencyReader.peek('resolveUsing');
      final resolveObject = resolveUsing?.objectValue.toFunctionValue();
      ...
      return LazySingletonDependency(
        ...
        .instanceOf(const TypeChecker.typeNamedLiterally('Presolve', inPackage: 'stacked_shared'))) {
      ...
      return PresolveSingletonDependency(
        ...
        .instanceOf(const TypeChecker.typeNamedLiterally('InitializableSingleton', inPackage: 'stacked_shared'))) {
      return InitializableSingletonDependency(
        ...
        .instanceOf(const TypeChecker.typeNamedLiterally('FactoryWithParam', inPackage: 'stacked_shared'))) {
